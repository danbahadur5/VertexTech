          ...
          <Card className="overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group bg-white dark:bg-gray-900">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-10">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4 leading-tight">{featuredPost.title}</h2>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{featuredPost?.author?.name}</div>
            ...
            {(loading ? [] : posts).map((post, idx) => (
              <Card key={post.id} className="reveal overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group border-0 shadow-md bg-white dark:bg-gray-900" style={{ transitionDelay: `${idx * 0.12}s` }}>
                ...
                <CardHeader className="pb-3">
                  ...
                  <CardTitle className="line-clamp-2 text-base leading-snug dark:text-gray-100">{post.title}</CardTitle>
                  <CardDescription className="line-clamp-2 text-sm dark:text-gray-400">{post.excerpt}</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between">
